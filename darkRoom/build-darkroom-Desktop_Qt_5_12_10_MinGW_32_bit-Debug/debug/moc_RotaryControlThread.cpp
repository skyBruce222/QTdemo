...
void RotaryControlThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<RotaryControlThread *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (RotaryControlThread::*)(QByteArray );
        ...
        {
            using _t = void (RotaryControlThread::*)(QString );
        ...
        {
            using _t = void (RotaryControlThread::*)(int );
        ...
        {
            using _t = void (RotaryControlThread::*)(double );
        ...
        {
            using _t = void (RotaryControlThread::*)(double , double , double );
...
QT_INIT_METAOBJECT const QMetaObject RotaryControlThread::staticMetaObject = { {
    &BaseControlThread::staticMetaObject,
    qt_meta_stringdata_RotaryControlThread.data,
    qt_meta_data_RotaryControlThread,
    qt_static_metacall,
    nullptr,
    nullptr
} };
