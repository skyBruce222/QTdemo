...
void MainWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (MainWindow::*_t)(const QString & , int , int , int , int );
        ...
        {
            typedef void (MainWindow::*_t)(AngleType & );
        ...
        {
            typedef void (MainWindow::*_t)(QList<double> );
        ...
        {
            typedef void (MainWindow::*_t)(float , float );
