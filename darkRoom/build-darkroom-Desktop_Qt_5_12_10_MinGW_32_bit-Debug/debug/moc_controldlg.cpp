...
void controldlg::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<controldlg *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (controldlg::*)(float , float );
        ...
        {
            using _t = void (controldlg::*)(float );
        ...
        {
            using _t = void (controldlg::*)(const QString & );
        ...
        {
            using _t = void (controldlg::*)(const QString & , int , int , int , int );
        ...
        {
            using _t = void (controldlg::*)(double );
...
QT_INIT_METAOBJECT const QMetaObject controldlg::staticMetaObject = { {
    &QDialog::staticMetaObject,
    qt_meta_stringdata_controldlg.data,
    qt_meta_data_controldlg,
    qt_static_metacall,
    nullptr,
    nullptr
} };
