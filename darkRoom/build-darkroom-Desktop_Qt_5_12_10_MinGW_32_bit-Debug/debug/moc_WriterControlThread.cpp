...
void WriterControlThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<WriterControlThread *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (WriterControlThread::*)(double );
...
QT_INIT_METAOBJECT const QMetaObject WriterControlThread::staticMetaObject = { {
    &QThread::staticMetaObject,
    qt_meta_stringdata_WriterControlThread.data,
    qt_meta_data_WriterControlThread,
    qt_static_metacall,
    nullptr,
    nullptr
} };
